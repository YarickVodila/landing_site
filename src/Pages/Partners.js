                ...
                <section className={"container-partners"}>
                    ...
                    <section className={'Logos'}>
                        ...
                        <section className={'About-partners'}>
                            ...
                            <p>
                                НАГ - аккредитованная российская компания-разработчик. Основной наш продукт - телекоммуникационное
                                оборудование и системная интеграция. За 19 лет работы мы вошли в топ-рейтинги от Урала до известных
                                мировых сообществ, таких как TAdviser, CNews, Экспортер Года.
